    ...
    public function createCheckoutSession(Request $request)
    {
        ...
        try {
            ...
            $session = Session::create([
                ...
                'mode' => 'payment',
                'success_url' => route('checkout.success') . '?session_id={CHECKOUT_SESSION_ID}', // Redirect after successful payment
                'cancel_url' => route('checkout.cancel'), // Redirect if the user cancels
            ]);
